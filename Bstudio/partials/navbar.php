      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex" role="search" method="get" action="search.php">
            ...
            if(!$loggedin){
            echo '<a class="btn btn-outline-success me-2" type="submit" href="/Bstudio/login.php">Login</a>
            <a class="btn btn-outline-success me-2" type="submit" href="/Bstudio/signup.php">Signup</a>';
            }
            if($loggedin){
